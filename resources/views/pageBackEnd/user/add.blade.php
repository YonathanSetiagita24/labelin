            ...
            <div class="panel panel-inverse" data-sortable-id="table-basic-1">
                ...
                <div class="panel-body">
                    <div class="form-group ">
                        <a href="{{ route('user.index') }}" class="btn btn-warning" style="float: right"><i class="fa fa-arrow-left"></i> Back</a>
                    </div>
                    <div class="col-md-6">
                        <form method="POST" action="{{ route('user.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="
                                                                exampleFormControlInput1" type="text" value="{{ old('name') }}" placeholder="Nama" name="name" autocomplete="off">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('password') is-invalid @enderror" id="
                                                                exampleFormControlInput1" type="password" value="{{ old('password_confirmation') }}" placeholder="Konfirmasi Password" name="password_confirmation">
                                @error('password')
                                <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
